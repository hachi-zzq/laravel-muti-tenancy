...
use Hachi\LaravelMutiTenancy\Contracts\Repositories\HostnameRepository as Contract;
use Hachi\LaravelMutiTenancy\Traits\DispatchesEvents;
use Hachi\LaravelMutiTenancy\Events\Hostnames as Events;
use Hachi\LaravelMutiTenancy\Validators\HostnameValidator;
...
class HostnameRepository implements Contract
{
    ...
    {
        logger(config('tenancy.hostname.default'));
